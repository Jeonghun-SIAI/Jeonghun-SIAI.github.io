var store = [{
        ...
        "title": "선형계획법 기반 분산에너지시스템 최적화 - 4) 태양광과 배터리의 '용량' 결정 (코드 및 결과 포함)",
        ...
        "teaser": "/assets/images/linprogfour/result_year.png"
      },{
        ...
        "title": "선형계획법 기반 분산에너지시스템 최적화 - 6) 공동주택의 '누진제' 전기요금 (단일계약) 수식",
        ...
        "tags": ["선형계획법","부하패턴","경제성분석","Python"],
        "url": "/linprogsix.html",
        "teaser": "/assets/images/linprogsix/graph.png"
      },{
        "title": "선형계획법 기반 분산에너지시스템 최적화 - 7) 전기 부하와 냉/난방 부하를 동시에 고려 (섹터커플링)",
        ...
        "teaser": "/assets/images/linprogseven/systemfigure.png"
      },{
        "title": "선형계획법 기반 분산에너지시스템 최적화 - 8) '부분'부하 관련 제약들",
        "excerpt":"지난 포스팅에서는 설비의 효율과 COP(성능계수)를 상수로 가정했지만, 실제로는 부하율에 따라 효율과 COP가 달라진다. 이를테면 열병합발전기의 경우, 최대 출력(정격 출력)으로 운전할 때 비해 더 낮은 출력으로 ‘부분부하’운전 시 발전효율이 저하됨이 알려져 있다. 열병합발전기의 통상적인 부하율-효율 그래프. 낮은 부하율에서 효율이 저하됨. 출처: “Modeling of non-linear CHP efficiency curves in distributed energy systems”...","categories": ["optimalsystem"],
        "tags": ["선형계획법","부하패턴","경제성분석","Python"],
        ...
        "teaser": "/assets/images/linprognine/portfolio.png"
      },{
        ...
        "teaser": "/assets/images/monthlyenergytwo/abnormalpattern.png"
      },{
        ...
        "excerpt":"지난 포스팅에서는 건물의 시간별 전기부하 추정 모델을 딥러닝이 아닌 ‘전통적인’ 선형회귀 (Weighted Least squares + 잔차에 대한 SARMA 보조회귀) 로 만들어 adjusted $R^2$ 0.95 이상의 우수한 성능을 얻을 수 있음을 보였다. 이번 포스팅에서는, 딥러닝을 써서 모델을 만들어 본다. Dense Neural Net 전기부하 데이터는 시계열 데이터이므로 Recurrent Neural Network (RNN) 을...","categories": ["estimation"],
        "tags": ["회귀분석","딥러닝","부하패턴"],
